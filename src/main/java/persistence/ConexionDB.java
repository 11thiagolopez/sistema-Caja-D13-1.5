...
public class ConexionDB {
	...
	public static void crearTablas() {
		...
		String sqlPersonas = "CREATE TABLE IF NOT EXISTS personas (" + "id INTEGER PRIMARY KEY AUTOINCREMENT,"
	...
	public static void respaldarBaseDeDatos() {
		try {
			...
			java.nio.file.Path destino = java.nio.file.Paths
					.get("C:/CajaCompartida/Backups/backup_d13_" + fecha + ".db");
